                ...
                <Card style={{ maxWidth: 600, padding: "20px 5px", margin: "0 auto", backgroundColor: "unset" }}>
                    <CardContent>
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid xs={12} item>
                                <TextField label='Factory Location' placeholder="Factory Location" variant="outlined" fullWidth required />
                            </Grid>
                        </Grid><br></br><br></br>
                        <Grid align="center">
...
export default transferSlaughter;